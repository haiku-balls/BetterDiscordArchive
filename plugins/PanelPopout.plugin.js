...
: (([Plugin, Api]) => {
    const plugin = (Plugin, Api) => {
        const {
            ...
            DiscordSelectors: {
                AccountDetails: AccountDetailsSelectors,
                Popouts: PopoutsSelectors
            },
            Popouts,
            Logger,
            Toasts
        ...
        const avatarSelector = AccountDetailsSelectors.avatar || (Logger.warn("Avatar selector missing") || AccountDetailsSelectors.avatarWrapper);
        const containerSelector = AccountDetailsSelectors.container || (Logger.warn("Container selector missing") || avatarSelector);
        const popoutSelector = PopoutsSelectors.popout || (Logger.warn("Popout selector missing") || (PopoutsSelectors.popouts && `${PopoutsSelectors.popouts} > *`));
